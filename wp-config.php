...
define('DB_NAME', 'd012abfa');

/** Ersetze username_here mit deinem MySQL-Datenbank-Benutzernamen */
define('DB_USER', 'd012abfa');

/** Ersetze password_here mit deinem MySQL-Passwort */
define('DB_PASSWORD', '');

/** Ersetze localhost mit der MySQL-Serveradresse */
define('DB_HOST', 'ruven.org');
 ...
 * @seit 2.6.0
 */
define('AUTH_KEY',         'asd2');
define('SECURE_AUTH_KEY',  'asd3');
define('LOGGED_IN_KEY',    'asd4');
define('NONCE_KEY',        'asd5');
define('AUTH_SALT',        'asd6');
define('SECURE_AUTH_SALT', 'asd7');
define('LOGGED_IN_SALT',   'asd8');
define('NONCE_SALT',       'asd9');
